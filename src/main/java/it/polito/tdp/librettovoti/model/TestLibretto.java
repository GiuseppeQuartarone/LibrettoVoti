...
public class TestLibretto {
	...
	public static void main(String[] args) {
		...
		lib.add(new Voto("Analisi 1", 30, LocalDate.of(2022, Month.APRIL, 4)));//sono i metodi più diretti
		lib.add(new Voto("Informatica", 25,LocalDate.parse("2022-04-05") ));//per creare date
